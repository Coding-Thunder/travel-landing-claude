...
export type FeaturedVehicle = {
  ...
  image: string;
  gradient: string;
  /** `efficiency` is optional: omit it rather than publish a figure the exact
...
export const siteConfig = {
   ...
   * Featured vehicles.
   *
   * Each entry is named from the vehicle actually shown in its image, checked
   * by eye against the photograph. Two earlier entries were removed rather than
   * relabelled: one used a second photograph of the Tesla already featured
   * below, and one used a photograph of a motorcycle, which is not a vehicle
   * class this business rents. Neither had a correct image available in the
   * project, and inventing one was not an option.
   */
  featuredVehicles: [
    { name: "Hyundai Elantra", type: "Economy", dailyRate: 29, rating: 4.8, image: "https://images.unsplash.com/photo-1550355291-bbee04a92027?auto=format&fit=crop&w=1100&q=80", gradient: "from-sky-500 to-blue-600", specs: { seats: 5, bags: 2, transmission: "Automatic", efficiency: "Up to 35 MPG" }, features: ["Apple CarPlay", "Backup camera", "Bluetooth"], tag: "Best value" },
    { name: "Honda CR-V", type: "SUV", dailyRate: 49, rating: 4.9, image: "https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?auto=format&fit=crop&w=1100&q=80", gradient: "from-blue-600 to-indigo-700", specs: { seats: 5, bags: 4, transmission: "Automatic", efficiency: "AWD · up to 30 MPG" }, features: ["All-wheel drive", "Roof rails", "Apple CarPlay"], tag: "Family favorite" },
    { name: "Tesla Model 3", type: "Electric", dailyRate: 59, rating: 4.9, image: "https://images.unsplash.com/photo-1560958089-b8a1929cea89?auto=format&fit=crop&w=1100&q=80", gradient: "from-emerald-500 to-teal-600", specs: { seats: 5, bags: 3, transmission: "Automatic", efficiency: "Up to 270 mi range" }, features: ["Autopilot", "Supercharging", "Premium audio"], tag: "Eco choice" },
    { name: "BMW M5", type: "Luxury", dailyRate: 89, rating: 4.9, image: "https://images.unsplash.com/photo-1555215695-3004980ad54e?auto=format&fit=crop&w=1100&q=80", gradient: "from-slate-700 to-slate-900", specs: { seats: 5, bags: 4, transmission: "Automatic" }, features: ["Heated seats", "Premium leather", "Navigation", "Driver assistance"], tag: "Premium" },
  ] as FeaturedVehicle[],
