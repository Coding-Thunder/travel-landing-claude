  ...
  return (
    <>
      ...
      <ServicePage
        ...
        description="Flights, stays, transfers and activities arranged together, with each element priced and its own cancellation terms stated separately, so you always know where you stand."
        tags={["Beach", "Family", "Honeymoon", "Luxury", "Adventure", "City breaks"]}
        ...
        categories={[
          ...
          { name: "Family Holidays", description: "Trips built around the ages traveling and the space you need." },
