...
export const metadata: Metadata = {
  title: "Contact Us: 24/7 Phone Reservations",
  description: `Car rental reservations and support. Call ${siteConfig.phoneDisplay} 24/7, request a callback, or email ${siteConfig.email}.`,
